...
module.exports = {
	getAll: function(req, res) {
		dbConnection.query("SELECT * FROM runs", function(error, results, fields) {
	...
	getOne: function(req, res) {
		...
		dbConnection.query("SELECT * FROM runs WHERE run_id = ?", run_id, function(error, results, fields) {
			if (error) throw error;
			return res.send({error: error, data: results, message: "Requested run"});
		});
	},
	create: function(req, res) {		
		dbConnection.query("INSERT INTO runs VALUES ()", function(error, results, fields) {
			if (error) throw error;
	...
	createWithTitle: function(req, res) {
		...
		dbConnection.query("INSERT INTO runs (title) VALUES (?)", title, function(error, results, fields) {
			if (error) throw error;
			return res.send({error: error, data: results, message: 'Created run, refer to insertID field of data'});
		});
	},
	createWithDetails: function(req, res) {
		...
		dbConnection.query("INSERT INTO runs (title, description) VALUES (?, ?)", [title, desc], function(error, results, fields) {
			if (error) throw error;
			return res.send({error: error, data: results, message: 'Created run, refer to insertID field of data'});
		});
	},
	modify: function(req, res) {
		...
		dbConnection.query("UPDATE runs SET title = ?, description = ? WHERE run_id = ?", [title, desc, run_id], function(error, results, fields) {
			if (error) throw error;
	...
	remove: function(req, res) {
		...
		dbConnection.query("DELETE FROM runs WHERE run_id = ?", run_id, function(error, results, fields) {
			if (error) throw error;
